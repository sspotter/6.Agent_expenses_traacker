...
// //             <label className="text-xs font-bold text-sub uppercase tracking-widest ml-1">Daily Status</label>
...
// //                         onClick={() => {
// //                           setStatus(s);
// //                           if (s === 'FULL') setAmount(currentExpected.toString());

// //                           // if (s === 'FULL') setAmount(expectedAmount.toString());
// //                           if (s === 'MISSED') setAmount('0');
// //                         }}
// //                         className={clsx(
...
//                             }
//                         }}
// className="w-full bg-gray-500 border border-primary/20 rounded px-2 text-2xl font-black text-main tracking-tight outline-none overflow-hidden"                        // className="w-full bg-white border border-primary/20 rounded px-2 text-2xl font-black text-main tracking-tight outline-none"
//                         aria-label="Expected Amount Override"
//                     />
//                 ) : (
//                     <p 
// className="  focus:text-black text-2xl font-black tracking-tight cursor-pointer hover:underline decoration-dashed decoration-primary/30"                        onClick={() => setIsEditingExpected(true)}
//                         title="Click to override daily expectation"
//                     >
//                         ${currentExpected}
//                     </p>
...
className="  focus:text-black text-2xl font-black tracking-tight cursor-pointer hover:underline decoration-dashed decoration-primary/30"                        onClick={() => setIsEditingExpected(true)}
          ...
          {allocatedAmount > 0 && (
             <div className="flex flex-col gap-2 p-4 bg-success/5 border border-success/10 rounded-2xl">
               ...
               <p className="text-[10px] leading-relaxed text-success/70 font-medium">
               This missing amount was recovered via late settlements for ${allocatedAmount} on the date of the first payment was for <strong>${expectedAmount - allocatedAmount}</strong>
               </p>
             </div>
          )}
